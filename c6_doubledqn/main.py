import numpy as np
import torch
from c6_doubledqn.ddqnagent import DDQNAgent
from c6_doubledqn.env_customization import make_env
from c6_doubledqn.utils import plot_learning_curve
...
if __name__=='__main__':
    ...
    agent = DDQNAgent(input_dims=(env.observation_space.shape), n_actions=env.action_space.n,
                     lr=0.0001, gamma=0.99, epsilon=1.0, epsilon_min=0.1, epsilon_dec=1e-5,
                     memory_size=50000, batch_size=32, replace=1000,
                     checkpoint_dir='models/', algo='DDQNAgent', env_name='PongNoFrameskip-v4')
