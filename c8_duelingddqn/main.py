import numpy as np
import torch
from c8_duelingddqn.dueling_ddqnagent import DuelingDDQNAgent
from c8_duelingddqn.env_customization import make_env
from c8_duelingddqn.utils import plot_learning_curve
...
if __name__=='__main__':
    ...
    agent = DuelingDDQNAgent(input_dims=(env.observation_space.shape), n_actions=env.action_space.n,
                     ...
                     checkpoint_dir='models/', algo='DuelingDDQNAgent', env_name='PongNoFrameskip-v4')
